...
func init() {
	...
	boundaryCreateCmd.PersistentFlags().StringVar(&boundaryHttpProxy, "http-proxy", "", "Set the HTTPS proxy location which should be used by all requests to access Boundary")
