...
func init() {
	...
	consulCreateCmd.PersistentFlags().StringVar(&consulHttpProxy, "http-proxy", "", "Set the HTTPS proxy location which should be used by all requests to access Consul")
